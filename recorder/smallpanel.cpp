...
SmallPanel::SmallPanel(Recorder *recorder) : recorder(recorder)
{
...
{
    nameLbl->setText(recorder->getPluginName());
}
...
void SmallPanel::recorderStateChanged()
{
...
void SmallPanel::recorderPositionChanged(QTime position)
{
    if(position.isValid())
